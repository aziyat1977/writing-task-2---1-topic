  ...
  return (
    <>
      ...
      <div className="fixed top-6 left-6 z-50 flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-1 bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-xl p-1 shadow-lg transition-colors">
      ...
      <div className="fixed top-6 right-6 z-50 flex items-center gap-4">
         ...
         {/* XP / Level Display */}
         <div className="hidden md:flex items-center gap-3 bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-xl p-2 pr-4 shadow-lg transition-colors">
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 h-full w-80 bg-white/95 dark:bg-[#020617]/95 border-r border-slate-200 dark:border-slate-800 z-50 overflow-y-auto backdrop-blur-xl transition-colors"
            >
              <div className="p-8 pt-24">
                ...
                <div className="mb-8">
                  <h3 className="text-2xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-emerald-600 dark:from-sky-400 dark:to-emerald-400 mb-2">Essay Construction</h3>
      ...
      <AnimatePresence>
        {isTopicOpen && (
            <>
                ...
                >
                    <div className="relative overflow-hidden rounded-2xl border border-white/20 dark:border-white/10 bg-white/90 dark:bg-slate-900/60 backdrop-blur-2xl p-8 shadow-2xl">
                         {/* Ambient Glow */}
                        ...
                        <button 
                            onClick={() => setIsTopicOpen(false)}
                            className="absolute top-4 right-4 text-slate-400 hover:text-slate-800 dark:hover:text-white transition-colors z-10"
                        >
                            <X size={24} />
                        </button>
                        
                        <div className="relative z-10 mb-8 border-b border-slate-200 dark:border-white/10 pb-6">
                            ...
                            <p className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-serif leading-relaxed drop-shadow-sm dark:drop-shadow-lg">
                            "{data.hero.topicText}"
                            </p>
                        </div>
